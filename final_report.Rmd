...
* `elevation_loss`: Elevation lost during the activity, mean = `r mean(tidy_training$elevation_loss)`
...
* `dewpoint`: Dew point during the activity, mean = `r mean(tidy_training$dewpoint)`
* `humidity`: Humidity (%) during the activity, mean = `r mean(tidy_training$humidity)`
* `wind_speed`: Wind speed in meters per second during the activity, mean = `r mean(tidy_training$wind_speed)`
